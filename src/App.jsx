...
import Tasks from "./components/Tasks/TasksContainer.jsx";
import Texts from "./components/Texts/Texts.jsx";
import Plans from "./components/Plans/PlansContainer.jsx";
import Goals from "./components/Goals/GoalsContainer.jsx";
            ...
            <div className="Navbar">
                ...
                <div className="navlinks">
                    <ul>
                        ...
                        <li><NavLink className={'navlink'} to={'/tasks'}>
                            Tasks
                        </NavLink></li>
                        <li><NavLink className={'navlink'} to={'/texts'}>
                            Texts
                        </NavLink></li>
                        <li><NavLink className={'navlink'} to={'/plans'}>
                            Plans
                        </NavLink></li>
                        <li><NavLink className={'navlink'} to={'/goals'}>
                            Goals
                        </NavLink></li>
                        <li><NavLink className={'navlink'} to={'/settings'}>
                            Settings
                        </NavLink></li>
                    </ul>
                </div>
